...
const serviceAccount = require("./askflow-firebase-adminsdk.json");
...
async function run() {
   try {
      ...
      // old (Keeping this route for compatibility, though '/payment-checkout-session' is preferred)
...
app.get('/', (req, res) => {
   res.send('askFlow in Hello World!')
})
